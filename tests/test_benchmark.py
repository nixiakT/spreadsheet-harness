...
@pytest.mark.parametrize(
    "manifest_path",
    [DERIVATIVE_POOL_MANIFEST, DERIVATIVE_PILOT_MANIFEST, DERIVATIVE_POSTOPT_MANIFEST],
)
...
@pytest.mark.parametrize(
    ...
    [("pool", "v1"), ("pilot", "pool"), ("postopt", "pool")],
)
...
@pytest.mark.parametrize("manifest_name", ["pool", "pilot", "postopt"])
